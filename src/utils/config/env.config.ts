...
export default {
  ...
  FIREBASE_PROJECT_ID: process.env.FIREBASE_PROJECT_ID || PaymentProvider.PAYSTACK,
  FIREBASE_PRIVATE_KEY_ID: process.env.FIREBASE_PRIVATE_KEY_ID || PaymentProvider.PAYSTACK,
  FIREBASE_PRIVATE_KEY: process.env.FIREBASE_PRIVATE_KEY || PaymentProvider.PAYSTACK,
  FIREBASE_CLIENT_EMAIL: process.env.FIREBASE_CLIENT_EMAIL || PaymentProvider.PAYSTACK,
  FIREBASE_CLIENT_ID: process.env.FIREBASE_CLIENT_ID || PaymentProvider.PAYSTACK,
}