...
import {DiscountTypes,  PromoConditions, PromoTypes, UserTypes } from "../../utils/enums/base.enum";
...
const schema = new mongoose.Schema(
  {
    ...
    condition: {
      type: String,
      enum: [PromoConditions.NUMBER_OF_GOODS_PURCHASED, PromoConditions.TOTAL_PRICE_SPENT_ON_GOODS, PromoConditions.NEW_USER, ""],
      default: "",
    },
    is_condition: {
      type: Boolean,
...
export default model("GeneralCoupon", schema);
